        ...
        <HeroContent>
          <div>
            ...
            <Description role="paragraph">
              I build thoughtful, elegant solutions to real-world problems through modern web development—always prioritizing user experience, clean code, and long-term maintainability.
            </Description>
            <SocialLinks role="list" aria-label="Social media links">
              <a 
                href="https://github.com/brnhrrldprz/" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/brnhrrldprz/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="mailto:brianharroldperez@gmail.com"
